...
<div class="container mt-5">
    <h2>Ajouter un Exemplaire pour le livre : ${livre.titre}</h2>
    <form action="/exemplaires/ajout" method="post">
        <input type="hidden" name="livre.id" value="${livre.id}" />
        <div class="mb-3">
            <label for="nomExemplaire" class="form-label">Nom de l'exemplaire</label>
            <input type="text" class="form-control" id="nomExemplaire" name="nomExemplaire" required>
        </div>
        <div class="mb-3">
