...
public class ParametrageGeneral {
    ...
    @Column(name = "jours_penalite_etudiant")
    private Integer joursPenaliteEtudiant = 10;
    @Column(name = "jours_penalite_enseignant")
    private Integer joursPenaliteEnseignant = 9;
    @Column(name = "jours_penalite_professionnel")
    private Integer joursPenaliteProfessionnel = 8;
    ...
    public Integer getJoursPenaliteEtudiant() { return joursPenaliteEtudiant; }
    public void setJoursPenaliteEtudiant(Integer joursPenaliteEtudiant) { this.joursPenaliteEtudiant = joursPenaliteEtudiant; }
    public Integer getJoursPenaliteEnseignant() { return joursPenaliteEnseignant; }
    public void setJoursPenaliteEnseignant(Integer joursPenaliteEnseignant) { this.joursPenaliteEnseignant = joursPenaliteEnseignant; }
    public Integer getJoursPenaliteProfessionnel() { return joursPenaliteProfessionnel; }
    public void setJoursPenaliteProfessionnel(Integer joursPenaliteProfessionnel) { this.joursPenaliteProfessionnel = joursPenaliteProfessionnel; }
