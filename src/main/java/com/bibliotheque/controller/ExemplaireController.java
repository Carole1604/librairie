...
public class ExemplaireController {
    ...
    @GetMapping("")
    public String index() {
        return "redirect:/exemplaires/liste";
    }
    ...
    @GetMapping("/liste")
    public String listeTousExemplaires(Model model) {
    ...
    @GetMapping("/ajout-global")
    public String ajoutGlobalForm(Model model) {
        model.addAttribute("exemplaire", new Exemplaire());
        model.addAttribute("livres", livreService.findAll());
        return "exemplaires/ajout-global";
    }

    @PostMapping("/ajout-global")
    public String ajouterExemplaireGlobal(@ModelAttribute Exemplaire exemplaire) {
        exemplaireService.save(exemplaire);
        return "redirect:/exemplaires/liste";
    }
